            ...
            <Container>
                <Row className="align-items-center">
                    ...
                    <Col className="col-12 col-lg-6 res-margin">
						...
						<h1 className="wow fadeInUp" style={{fontFamily: 'Fredoka One, cursive'}} data-wow-offset="10" data-wow-duration="1s" data-wow-delay="0s">
                                THE HEART OF HOME COOKING<br />NOW MOBILE WITH iCrave
                            </h1>
